...
# ones.
extensions = ['sphinx_tojupyter', 'sphinx.ext.mathjax']
...
tojupyter_write_metadata = False

# Location for _static folder
tojupyter_static_file_path = ["_static"]

#allow execution of notebooks
tojupyter_execute_notebooks = False

#make website
tojupyter_make_site = False

#path to download notebooks from 
tojupyter_download_nb_urlpath = "https://lectures.quantecon.org"

#allow downloading of notebooks
tojupyter_download_nb = False

# Location of template folder for coverage reports
tojupyter_template_coverage_file_path = "theme/templates/error_report_template.html"

# generate html from IPYNB files
tojupyter_generate_html = False

tojupyter_html_template = "theme/templates/lectures-nbconvert.tpl"
...
tojupyter_welcome_block = "welcome.rst"
...
tojupyter_lang_synonyms = ["ipython", "python", "pycon"]

# Image Prefix (enable web storage references)
# tojupyter_download_nb_image_urlpath = "https://github.com/QuantEcon/sphinxcontrib-jupyter/raw/master/tests/_static/"
tojupyter_download_nb = False
